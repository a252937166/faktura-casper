...
| 2   | **Demo video** (3 min)                                                                                                                                                                                                            | [youtu.be/Omidi47zryc](https://youtu.be/Omidi47zryc)                                                                                                                      |
...
| 8   | **GitHub release** (CI green: fmt, clippy, 12 contract tests, typecheck, format, web build)                                                                                                                                       | [github.com/a252937166/faktura-casper/releases/tag/v0.2.4-final](https://github.com/a252937166/faktura-casper/releases/tag/v0.2.4-final)                                  |
...
And on the live site: press **▶ Use the live AI desk · 3–6 min**, then run the
