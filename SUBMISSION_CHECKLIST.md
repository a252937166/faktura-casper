...
| 8 | **GitHub release** (CI green: fmt, clippy, 12 contract tests, typecheck, format, web build) | [github.com/a252937166/faktura-casper/releases/tag/v0.2.3-final](https://github.com/a252937166/faktura-casper/releases/tag/v0.2.3-final) |
